//
//  UIViewController+CustomPopupViewController.m
...
@interface UIViewController (CustomPopupViewControllerPrivate)
- (UIView*)topView;
...
@implementation UIViewController (CustomPopupViewController)
...
- (void)dismissPopupViewControllerWithanimationType:(CustomPopupViewAnimation)animationType
{
    ...
    if(animationType == CustomPopupViewAnimationSlideBottomTop || animationType == CustomPopupViewAnimationSlideBottomBottom || animationType == CustomPopupViewAnimationSlideRightLeft) {
...
//    popupView.layer.shadowOpacity = 0.5;
    ...
    // BackgroundView
    CustomPopupView *backgroundView = [[CustomPopupView alloc] initWithFrame:sourceView.bounds];
...
//    [overlayView addSubview:dismissButton];
    ...
    if(animationType == CustomPopupViewAnimationSlideBottomTop) {
    ...
    } else if (animationType == CustomPopupViewAnimationSlideRightLeft) {
        ...
        [self slideViewIn:popupView sourceView:sourceView overlayView:overlayView withAnimationType:animationType];
    } else if (animationType == CustomPopupViewAnimationSlideBottomBottom) {
...
{
    [self dismissPopupViewControllerWithanimationType:CustomPopupViewAnimationSlideBottomTop];
}

- (void)dismissPopupViewControllerWithanimationTypeSlideBottomBottom
{
    [self dismissPopupViewControllerWithanimationType:CustomPopupViewAnimationSlideBottomBottom];
}

- (void)dismissPopupViewControllerWithanimationTypeSlideRightLeft
{
    [self dismissPopupViewControllerWithanimationType:CustomPopupViewAnimationSlideRightLeft];
}
...
- (void)slideViewIn:(UIView*)popupView sourceView:(UIView*)sourceView overlayView:(UIView*)overlayView withAnimationType:(CustomPopupViewAnimation)animationType
{
    ...
    if(animationType == CustomPopupViewAnimationSlideBottomTop || animationType == CustomPopupViewAnimationSlideBottomBottom) {
