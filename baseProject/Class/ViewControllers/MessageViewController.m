...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MessageTableViewCell *cell = [_tableView dequeueReusableCellWithIdentifier:identifier];
    if (cell == nil) {
...
- (void)getData {
    ...
    [manager POST:[NSString stringWithFormat:@"%@/member-message/page", kSERVE_URL] parameters:dic success:^(AFHTTPRequestOperation *operation, id responseObject) {
